...
<body data-page="ibu" data-role="<?= htmlspecialchars(current_user_role(), ENT_QUOTES, 'UTF-8') ?>">
  <div class="sidebar">
    ...
    <ul>
      ...
      <li><a href="ibu.php" class="active"><i class="fa-solid fa-person-pregnant"></i> Data Ibu Hamil</a></li>
  ...
  <div class="main">
    <header><h1><i class="fa-solid fa-person-pregnant"></i> Data Ibu Hamil</h1></header>
    ...
    <div class="table-box">
      <table>
        <thead><tr><th>No</th><th>Nama</th><th>Usia (minggu)</th><th>Alamat</th><th>Diinput Oleh</th><th>Aksi</th></tr></thead>
