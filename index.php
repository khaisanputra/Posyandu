...
<body data-page="index" data-role="<?= htmlspecialchars(current_user_role(), ENT_QUOTES, 'UTF-8') ?>">
  ...
  <div class="main">
    <header>
      ...
      <p class="title-like">Pantau layanan kesehatan ibu dan tumbuh kembang balita secara cepat dalam satu dashboard terpadu.</p>
    </header>

    <div class="cards">
      <a class="card pink" href="balita.php">
        <i class="fa-solid fa-baby"></i>
        <h3>Jumlah Balita</h3>
        <p id="cardBalita">0</p>
      </a>
      <a class="card blue" href="ibu.php">
        <i class="fa-solid fa-person-pregnant"></i>
        <h3>Ibu Hamil</h3>
        <p id="cardIbu">0</p>
      </a>
      <a class="card green" href="imunisasi.php">
        <i class="fa-solid fa-syringe"></i>
        <h3>Total Imunisasi</h3>
        <p id="cardImun">0</p>
      </a>
      <a class="card yellow" href="jadwal.php">
